...
import { Card, SectionHeader, StatusBadge, StatCard, DataTable, type Column, QueryState } from '@farmhith/ui';
...
export default function AdminBookingsPage() {
  ...
  const { data: bookings, loading, error } = useAllSoilTestBookings();
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <QueryState
        ...
        emptyProps={{
          ...
          description: "No soil test bookings match this filter."
        }}
      >
        <DataTable
          columns={columns}
