...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      await login('LAB', { email, password });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-500">New lab? <a href="/register" className="text-blue-600 font-medium hover:underline">Register your lab</a></p>
          </div>
          <div className="mt-4 bg-blue-50 rounded-xl px-4 py-3 text-xs text-blue-700 border border-blue-100">
            <strong>Demo mode:</strong> Enter any email and click Sign In to enter as AgroScience Lab
          </div>
        </div>
      </div>
    </div>
