...
import { MapPin, Weight, CalendarDays, User, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
          ...
          <Card>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
               ...
               <div className="flex items-start gap-3">
                 ...
                 <div>
                    <p className="text-xs text-gray-500">Distance Appx</p>
                    <p className="font-medium text-gray-900">~ 42 km</p>
                 </div>
               </div>
            </div>
      ...
      <Modal
         ...
         footer={
           <>
             <Button variant="outline" onClick={() => setConfirmModal(false)} disabled={loading}>Cancel</Button>
